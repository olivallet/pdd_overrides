 ...
 *}
 ...
 <tr>
     ...
     <th class="product header small" width="{$layout.product.width+5}%">{l s='Product' d='Shop.Pdf' pdf='true'}</th>

     {if isset($layout.before_discount)}
         <th class="product header small" width="{$layout.unit_price_tax_excl.width}%">{l s='Base price' d='Shop.Pdf' pdf='true'} <br /> {l s='(Tax incl.)' d='Shop.Pdf' pdf='true'}</th>
     {/if}

     <th class="product header-right small" width="{$layout.unit_price_tax_excl.width}%">{l s='Unit Price' d='Shop.Pdf' pdf='true'} <br /> {l s='(TTC)' d='Shop.Pdf' pdf='true'}</th>
     <th class="product header small" width="{$layout.quantity.width+3}%">{l s='Qty' d='Shop.Pdf' pdf='true'}</th>
     <th class="product header-right small" width="{$layout.total_tax_excl.width}%">{l s='Total' d='Shop.Pdf' pdf='true'} <br /> {l s='(TTC)' d='Shop.Pdf' pdf='true'}</th>
 </tr>
 </thead>
